...
export default function SelectedProduct() {
    ...
    const removeItem = (arr, value) => arr.filter(function( obj ) {
        ...
        return (
            ...
            <section id="sproduct" className="container my-5 pt-5">
                <div className="row mt-5">
                    ...
                    <div className="col-lg-6 col-md-12 col-12">
                        ...
                        {product && product.rating && <Rating rating={product.rating} />}
            ...
            <section className="py-5 my-5">
                ...
                <div className="row mx-auto container">
                    {product && product.category_products && <ProductList products={removeItem(product.category_products, product)} />}
                </div>
            </section>
            </>
        )
